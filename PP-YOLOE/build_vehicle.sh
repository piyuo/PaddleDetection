...
MODEL_NAME="mot_ppyoloe_s_36e_ppvehicle"
MODEL_WEIGHT="PP-YOLOE/build/weights/${MODEL_NAME}.pdparams"
MODEL_CONFIG="configs/ppvehicle/${MODEL_NAME}.yml"
MODEL_PRODUCT_NAME="vehicle"
DEMO_JPG="PP-YOLOE/build/dataset/demo/vehicle.jpg"
