# PP-YOLOE/src/export_to_ncnn.sh
#!/usr/bin/env bash
...
OUTPUT_DIR="PP-YOLOE/build/models/"
...
param_file = "PP-YOLOE/build/models/ppyoloe_crn_s_36e_pphuman_ncnn.param"
bin_file = "PP-YOLOE/build/models/ppyoloe_crn_s_36e_pphuman_ncnn.bin"
...
if [ -f "PP-YOLOE/build/dataset/demo/demo.jpg" ]; then
