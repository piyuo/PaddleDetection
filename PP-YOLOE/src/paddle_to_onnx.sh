...
#
# Usage:
#   bash PP-YOLOE/src/paddle_to_onnx.sh [--shape 3,640,640] [--opset 11] \
...
DEFAULT_WEIGHTS="${REPO_ROOT}/PP-YOLOE/build/weights/ppyoloe_crn_s_36e_pphuman.pdparams"
...
Notes:
	...
	- If PP-YOLOE/build/venv exists, it will be sourced automatically.
EOF
}
...
rm -rf PP-YOLOE/build/models/inference_model

# print the final model is in PP-YOLOE/build/models/ppyoloe_crn_s_36e_pphuman.onnx
